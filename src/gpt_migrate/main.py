...
from gpt_migrate.utils import detect_language, build_directory_structure
from gpt_migrate.steps.setup import create_environment
from gpt_migrate.steps.migrate import get_dependencies, write_migration, add_env_files
from gpt_migrate.steps.test import (
    run_dockerfile,
    create_tests,
    validate_tests,
    run_test,
)
from gpt_migrate.steps.debug import debug_testfile, debug_error
...
def main(
    ...
    sourcelang: str = typer.Option(
        help="Source language or framework of the code to be migrated."
    ),
